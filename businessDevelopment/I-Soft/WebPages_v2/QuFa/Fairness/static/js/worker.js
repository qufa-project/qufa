...
var readFiles = function (files, columns, whendone)
{
    ...
    var readFile = function (file)
    {
        ...
        var objData = { columns: parsedData.columns, rows: parsedData.filter((elemet) => elemet !== 'columns') };
        aList.push({ data: objData, name: file.name });
...
self.addEventListener('message', function (e){ readFiles(e.data.files, e.data.columns, function(aList){ postMessage(aList); }); }, false);