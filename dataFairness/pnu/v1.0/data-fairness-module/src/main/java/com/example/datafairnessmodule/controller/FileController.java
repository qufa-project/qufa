...
public class FileController {
    ...
    @PostMapping("/compensation/submitUpload")
    public Map<String, Object> compensationSubmitUpload(@RequestParam("file") MultipartFile file, HttpServletRequest request) throws Exception {
...
//        return new SubmitFormResponse(sourceFileName, sourceFileDownloadUri, file.getContentType(), file.getSize());
    ...
    @PostMapping("/compensation/submitConvert")
    public Map<String, Object> compensationSubmitConvert(@RequestParam(value = "select") List<String> select, HttpServletRequest request) throws Exception {
...
//        return new SubmitFormResponse(sourceFileName, sourceFileDownloadUri, file.getContentType(), file.getSize());
    ...
    @PostMapping("/compensation/submitDownload")
    public Map<String, Object> compensationSubmitDownload(@RequestParam(value = "filenames") List<String> filenames, HttpServletRequest request) throws Exception {
        String origin = request.getParameter("origin");
        String except = request.getParameter("except");
    ...
    @PostMapping("/compensation/convertRun")
    @ResponseBody
    public Map<String, Object> compensationConvertRun(@RequestBody Map<String, Object> map1) throws Exception {
        ...
        for (Map<String, Object> map3 : list1) {
            Map<String, Object> map4 = compensationConvert(filename, except, map3);
            list2.add(map4);
    ...
    public Map<String, Object> compensationConvert(String filename, String except, Map<String, Object> map1) throws Exception {
...
//                logger.info(i + "." + j + ":" + columns[j].trim() + "::select:" + match_select + ",exclude:" + match_exclude + ",include:" + match_include);
    ...
    public Map<String, Object> compensationMerge(Map<String, Object> map1) throws Exception {
        Map<String, Object> map2 = new HashMap<>();
        return map2;
    }
